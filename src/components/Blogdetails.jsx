        ...
        <div className="proloy-blog-details-wraper border-[1px] border-solid border-[#f1f1f1] p-5">
          <div className="blog-details-content">
            ...
            <h3 className="mb-[15px] leading-normal text-[30px] font-semibold capitalize">
              {t(BlogdetailsData.title2)}
            </h3>
            <p>{BlogdetailsData.paragraph2}</p>
            <p>{BlogdetailsData.paragraph3}</p>
            <blockquote className="block-quote z-[1] relative bg-white border-l-[6px] border-solid border-l-[#06bbc4] !p-[35px] shadow-[0px_0px_30px_0px_rgba(26,43,60,0.15)] rounded-md overflow-hidden my-10 mx-0 before:content-['\f10d'] before:absolute before:-top-[20%] before:left-[5%] before:font-Fontawesome before:text-[#06bbc4] before:text-[150px] before:leading-[1] before:opacity-[0.1] before:-z-[1]">
              <p className=" text-[20px] text-[#1a2b3c] italic font-semibold leading-8">
                {t(BlogdetailsData.blockquote)}
              </p>
              <cite className=" relative pl-[15px] text-[16px] font-semibold capitalize mt-[30px] block before:h-[2px] before:bg-[#06bbc4] before:my-0 before:mx-auto before:absolute before:content-[''] before:bottom-0 before:w-[10px] before:top-[50%] before:left-0 before:-translate-y-[50%]">
          ...
          <div className="blog-post-tag pt-[30px] bg-white w-full overflow-hidden">
            <span className=" mb-[17px] text-[20px] font-semibold block text-[#1a2b3c] capitalize">
              {t(BlogdetailsData.tagtitle)}
            </span>
            {BlogdetailsData.TagsList.map((item, i) => (
              <Link
                key={i}
                className=" py-[10px] px-6 duration-[0.3s] mb-[10px] text-[#1a2b3c] inline-block text-[14px] font-medium capitalize border-[1px] border-solid border-[#e5e5e5] mr-[5px] rounded-none hover:text-white hover:border-[#06bbc4] hover:bg-[#06bbc4]"
                to={item.link}
              >
                {item.title}
              </Link>
              ...
              <div className="container">
                <div className="flex flex-wrap mx-[-12px]">
                  <div className="xl:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                    <input
                      type="text"
                      className="form-control shadow-none text-[#777777] h-[50px] mb-[30px] bg-white border-[1px] border-solid border-[#e7eaf0] py-[5px] px-5 transition-all duration-[0.3s] w-full focus:!shadow-[0px_10px_14px_0px_rgba(12,0,46,0.06)] focus:border-[1px] focus:border-solid focus:border-[#06bbc4] focus:!ring-[none] focus:!outline-offset-0 focus:outline-0"
                      placeholder={t("Name *")}
                    />
                  </div>
                  <div className="xl:w-6/12 w-full flex-[0_0_auto] px-[12px] max-w-full">
                  ...
                  <div className="w-full flex-[0_0_auto] px-[12px] max-w-full">
                    <textarea
                      name="comments"
                      className="form-control h-[133px] shadow-none text-[#777777] mb-[30px] bg-white border-[1px] border-solid border-[#e7eaf0] py-[15px] px-5 transition-all duration-[0.3s] w-full focus:!shadow-[0px_10px_14px_0px_rgba(12,0,46,0.06)] focus:border-[1px] focus:border-solid focus:border-[#06bbc4] focus:!ring-[none] focus:!outline-offset-0 focus:outline-0"
                      cols="30"
                      rows="10"
                  ...
                  <div className="w-full flex-[0_0_auto] px-[12px] max-w-full">
                    <button className="btn-1">{t(BlogdetailsData.btn)}</button>
                  </div>
                </div>
              </div>
            </form>
